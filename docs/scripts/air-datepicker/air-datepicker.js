  ...
  return (function () {
    ...
    function b(e) {
      ...
      return (
        ...
        isNaN(t.getTime()) &&
          (console.log(`Unable to convert value "${e}" to Date object`), (t = !1)),
        t
      )
    }
    function k(e) {
      ...
      constructor() {
        ...
        $(this, "focus", () => {
          ...
          $(this, "onChangeSelectedDate", () => {
            this.isDisabled ||
              (this._handleSelectedStatus(), this.opts.range && this._handleRangeStatus())
          }),
          ...
          $(
            ...
            "render",
            () => (
              (this.$cell.innerHTML = this._getHtml()), (this.$cell.adpCell = this), this.$cell
            )
          ),
          (this.type = e),
    ...
    class B {
      ...
      init() {
        ...
        ;(!R || (R && P && !o.contains(P))) &&
          ...
          this.elIsInput &&
            (i || this._bindEvents(), r && !h && (this.keyboardNav = new A({ dp: this, opts: e }))),
